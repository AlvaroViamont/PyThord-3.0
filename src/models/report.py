...
class PDF(FPDF):
    ...
    def build(self, data:dict):
        ...
        self.add_page()
        self._create_comparative_plot_analytic_section(data['Time(ms)'], data['CDSagital'], data['CISagital'], 'Caderas en el plano Sagital', 'Tiempo (ms)', 'CD vs CI')
        self._create_comparative_plot_analytic_section(data['Time(ms)'], data['CDFrontal'], data['CIFrontal'], 'Caderas en el plano Frontal', 'Tiempo (ms)', 'CD vs CI')
        self.add_page()
        self._create_comparative_plot_analytic_section(data['Time(ms)'], data['RDSagital'], data['RISagital'], 'Rodilla en el plano Sagital', 'Tiempo (ms)', 'RD vs RI')
        self._create_comparative_plot_analytic_section(data['Time(ms)'], data['RDFrontal'], data['RIFrontal'], 'Rodilla en el plano Frontal', 'Tiempo (ms)', 'RD vs RI')
