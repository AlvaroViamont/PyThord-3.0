...
if __name__ == "__main__":
    ...
    app_controller = AppController (user_model=user_model, patient_model=patient_model, stride_model=stride_model, user_view=None, patient_view=None, stride_view=None, data_size=350)
